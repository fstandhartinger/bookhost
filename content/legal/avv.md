...
| TensorX Limited | Unit 25, Classon House, Dundrum Business Park, Dublin 14, Irland; KI-Inferenz für die Upload-Beta, die Wiki-Antworten-Beta und die optionale semantische Wiki-Indexierung (Beta) | Unterauftragsverarbeiter für die verfügbare Upload-Beta auf Veranlassung des Kunden je Upload. Extrahierte Dokumenttexte, Seitenvorschläge, Wiki-Chat-Fragen samt der zur Beantwortung abgerufenen Seitenpassagen und erforderliche technische Metadaten; bei aktivierter semantischer Wiki-Indexierung zusätzlich der Text aller Seiten des eigenen Workspaces zur Berechnung von Suchvektoren, die samt Textpassagen in der Datenbank von BookHost verbleiben; kein E-Mail-Eingang. | Dokumentierte GPU-Infrastruktur in Dublin (Irland) und Helsinki (Finnland); Null-Retention von Prompts und Completionen in der ephemeren Verarbeitung nach § 2.2.3 der Vendor-DPA (Anlage 1: „Zero data retention“), die über die Vendor-Nutzungsbedingungen automatisch einbezogen ist; aktuelle Unterauftragsverarbeiterliste in Anlage 1 der DPA (u. a. Digital Realty in Dublin und Verda in Finnland für die Rechenzentrums-Infrastruktur; Resend, Intercom und Attio für die eigenen Abläufe von TensorX, teilweise außerhalb der EU auf Grundlage von Standardvertragsklauseln) und unter [tensorx.ai/sub-processors](https://tensorx.ai/sub-processors). Vor Nutzung mit personenbezogenen Kundeninhalten gilt die nachstehende Aktivierungsvoraussetzung. |

### TensorX: Bestätigung und Aktivierungsvoraussetzungen

TensorX Limited, registered office Unit 25, Classon House, Dundrum Business Park, Dublin 14, Irland, betreibt den Inferenzdienst der Upload-Beta. Die GPU-Infrastruktur liegt laut Anbieterangaben in Dublin (Irland) und Helsinki (Finnland). Die Vendor-DPA ist über die Vendor-Nutzungsbedingungen automatisch einbezogen; § 2.2.3 der DPA (Anlage 1: „Zero data retention“) sieht vor, dass Prompts und Completionen in der ephemeren Verarbeitung nicht gespeichert werden (Null-Retention). Die aktuelle Liste der Unterauftragsverarbeiter des Anbieters ist unter [tensorx.ai/sub-processors](https://tensorx.ai/sub-processors) veröffentlicht. Diese Angaben stammen vom Anbieter; sie sind eine Beschreibung der Verarbeitung und keine rechtliche Bewertung durch BookHost.

Die Upload-Beta ist technisch verfügbar. Bei jedem Upload wird der extrahierte Text, nicht die Originaldatei, an TensorX Limited zur Erstellung eines Seitenentwurfs mit Zusammenfassung, Tags und Prüfliste übermittelt. Ohne Upload findet über diese Funktion keine Übermittlung an TensorX statt. Originaldateien werden bei BookHost temporär gespeichert und nach Abschluss des Verarbeitungsversuchs entfernt; nach Unterbrechungen erfolgt die Bereinigung beim Start oder im stündlichen Lauf für temporäre Verzeichnisse, die älter als 30 Minuten sind. Gespeicherter Quelltext wird bei Veröffentlichung oder Ablehnung entfernt. Intake-Einträge einschließlich Entwürfen werden unabhängig von der Vertragslaufzeit nach 30 Tagen ab Erstellung beim nächsten stündlichen Bereinigungslauf gelöscht. Für veröffentlichte BookStack-Seiten und Sicherungen gelten die Vertragsende-Fristen. Diese Beschreibung der technischen Verarbeitung ist keine rechtliche Bewertung und kein Compliance-Nachweis. Vor Nutzung mit personenbezogenen Kundeninhalten gilt die nachstehende Aktivierungsvoraussetzung; bis dahin darf die Beta nur mit nicht personenbezogenen Beispieldokumenten genutzt werden. Diese Nutzungsbeschränkung ist keine technische Upload-Sperre. Für veröffentlichte BookStack-Seiten und Sicherungen gilt Abschnitt 8; Anwendungsprotokolle nach 14 Tagen, Sicherheitsprotokolle nach 30 Tagen.

Die semantische Wiki-Indexierung („Matching by meaning“, Beta) ist für einen Workspace nicht aktiviert, bis ein Owner oder Admin sie im Dashboard aktiviert. Bei Aktivierung wird der Text aller Seiten des eigenen Workspaces an TensorX Limited zur Berechnung von Suchvektoren übermittelt; die Vektoren und die zugehörigen Textpassagen werden in der eigenen Datenbank von BookHost auf Servern in der EU gespeichert und stündlich aktualisiert. Beim Deaktivieren werden Vektoren und Textpassagen sofort gelöscht. Ohne Aktivierung findet über diese Funktion keine Übermittlung an TensorX statt. Für die Nutzung mit personenbezogenen Kundeninhalten gilt dieselbe Aktivierungsvoraussetzung wie für die Upload-Beta.

Voraussetzung für die Nutzung mit personenbezogenen Kundeninhalten ist die abschließende Freigabe nach Prüfung der aktualisierten Verarbeitungsbedingungen (Vendor-DPA einschließlich § 2.2.3, aktuelle Unterauftragsverarbeiterliste, dokumentierte Verarbeitungsorte). Bis zu dieser Freigabe ist die Nutzung mit personenbezogenen Kundeninhalten nicht freigegeben; die technische Verfügbarkeit der Beta ist kein Nachweis dieser Freigabe.

Bis zu dieser Freigabe dürfen keine personenbezogenen Kundeninhalte an TensorX übermittelt werden. Die Annahme dieses AVV ist keine Einwilligung in unbestimmte Übermittlungen.
