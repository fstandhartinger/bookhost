...
| TensorX Limited | Unit 25, Classon House, Dundrum Business Park, Dublin 14, Irland; KI-Inferenz für die Upload-Beta | Unterauftragsverarbeiter für die verfügbare Upload-Beta auf Veranlassung des Kunden je Upload. Extrahierte Dokumenttexte, Seitenvorschläge und erforderliche technische Metadaten; kein E-Mail-Eingang und keine KI-Antwortfunktion. | Dokumentierte GPU-Infrastruktur in Dublin (Irland) und Helsinki (Finnland); Null-Retention von Prompts und Completionen in der ephemeren Verarbeitung nach § 3.2 der Vendor-DPA, die über die Vendor-Nutzungsbedingungen automatisch einbezogen ist; aktuelle Unterauftragsverarbeiterliste unter [tensorx.ai/sub-processors](https://tensorx.ai/sub-processors). Vor Nutzung mit personenbezogenen Kundeninhalten gilt die nachstehende Aktivierungsvoraussetzung. |
