...
export const metadata: Metadata = {
  ...
  description:
    "Move an existing BookStack instance to Wissen with a database dump and file archive. See what we migrate, what you check, and how the switch-over works.",
  alternates: { canonical: "/migrate" },
  openGraph: {
    title: "Move your existing BookStack · Wissen",
    description:
      "A practical guide to moving an existing BookStack instance to Wissen.",
    url: "/migrate",
    type: "website",
  },
};
  ...
  return (
    <article className="section mx-auto max-w-4xl">
      <header className="max-w-3xl">
        ...
        <p className="lede">
          Bring your current BookStack content to a private Wissen workspace.
