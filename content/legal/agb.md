...
Individuelle Vereinbarungen haben Vorrang. Abweichende Geschäftsbedingungen eines Unternehmenskunden werden nur bei ausdrücklicher Zustimmung Vertragsbestandteil.
...
BookHost stellt dem Kunden eine über das Internet erreichbare BookStack-Instanz zur Verwaltung von BookStack-Seiten und Anhängen bereit. Zum Team-Tarif gehören deren Betrieb, notwendige Wartung und Sicherheitsaktualisierungen, tägliche Backups mit altersbasierter Rotation gemäß Abschnitt 6 sowie Support per E-Mail. Der Team-Tarif umfasst bis zu 25 BookHost-Dashboard-Mitglieder je Workspace einschließlich des Owners. Direkt in BookStack angelegte oder importierte Konten werden von dieser Grenze nicht erfasst. 5 GB Upload-Speicher sind inklusive (1 GB = 1 Milliarde Bytes). Die Upload-Verzeichnisse werden regelmäßig gemessen; im Dashboard erscheint standardmäßig ab 80 % ein Hinweis. Bei Überschreitung wird der Upload nicht automatisch gesperrt. Bitte kontaktieren Sie bei höherem Speicherbedarf den Support; automatische Speicherhinweise per E-Mail werden nicht versandt. Für CPU- und Datenbankressourcen gilt Fair Use im Rahmen der üblichen BookStack-Verwaltung eines Teams dieser Größe. Bei höherem Bedarf an Nutzern, Speicher oder Rechen- und Datenbankressourcen kontaktieren Sie uns für eine individuelle Vereinbarung. Die konkrete Instanzadresse ergibt sich aus der Bestellbestätigung.
...
Bei ausbleibender Zahlung informieren wir den Kunden und setzen eine angemessene Zahlungsfrist. Eine verhältnismäßige Sperrung kommt erst nach erfolgloser Frist und vorheriger Ankündigung in Betracht, soweit das Gesetz dies zulässt. Gesetzliche Rechte bei Verzug bleiben bestehen; eine sofortige Datenlöschung allein wegen eines fehlgeschlagenen Zahlungsvorgangs erfolgt nicht.

## 5. Laufzeit und Kündigung

Der entgeltliche Vertrag hat eine monatliche Abrechnungsperiode. Er läuft anschließend unbefristet weiter und kann jederzeit mit Wirkung zum Ende der laufenden monatlichen Abrechnungsperiode gekündigt werden. Es gibt keine zusätzliche Kündigungsfrist und keine neue Jahresbindung. Für Verbraucher beträgt die Kündigungsfrist keinesfalls mehr als einen Monat.
...
Wir streben eine Verfügbarkeit von **99 % im Kalendermonat** an. Dies ist ein Betriebsziel und keine gesonderte Verfügbarkeitsgarantie mit automatischen Servicegutschriften. Maßstab ist die Erreichbarkeit der Kernfunktionen der Kundeninstanz am Internetanschluss unseres Systems. Störungen im Endgerät oder Internetzugang des Kunden liegen außerhalb dieses Messbereichs. Wartungsbedingte Ausfälle werden bei der Betrachtung des Betriebsziels nicht pauschal ausgeblendet. Gesetzliche Ansprüche wegen Leistungsstörungen bleiben bestehen.
...
Der Kunde benennt berechtigte Nutzer, schützt deren Zugänge und vergibt Berechtigungen dem tatsächlichen Bedarf entsprechend. Sicherheitsverdächtige Vorgänge und Störungen meldet er unverzüglich, soweit ihm zumutbar. Er darf nur Inhalte einstellen und verarbeiten lassen, für die er die notwendigen Rechte und datenschutzrechtlichen Befugnisse besitzt. Rechtswidrige Inhalte, Schadsoftware und vorsätzliche Beeinträchtigungen des Dienstes sind untersagt.

Der Kunde behält seine Rechte an den eingebrachten Inhalten. Er räumt uns ausschließlich die für Hosting, Sicherung, Wiederherstellung und beauftragte Verarbeitung notwendigen, zeitlich auf die Vertragsabwicklung beschränkten Befugnisse ein. Rechte Dritter an Open-Source-Software bleiben unberührt; der Hostingpreis ist keine Lizenzgebühr für die freie BookStack-Software.

Bei konkreten Rechtsverletzungen oder Gefahren dürfen wir die betroffene Nutzung im erforderlichen Umfang beschränken. Soweit vertretbar, informieren wir vorher und geben Gelegenheit zur Abhilfe. Dringende Maßnahmen werden nachträglich erläutert. Die Maßnahme endet, sobald ihr Grund entfällt.

## 8. Datenschutz und Vertraulichkeit

Für personenbezogene Kundeninhalte schließen die Parteien den [AVV](avv.md), der vor Beginn einer solchen Verarbeitung wirksam einzubeziehen ist. Für eigene Konto- und Abrechnungsverarbeitungen gilt die [Datenschutzerklärung](datenschutz.md). Beide Parteien behandeln nicht öffentliche Informationen der anderen Partei vertraulich, auch nach Vertragsende. Gesetzliche Offenlegungspflichten bleiben unberührt.

## 9. Export und Vertragsende
...
Es gelten die gesetzlichen Mängelrechte. Bei Verbrauchern bleiben insbesondere die zwingenden Vorschriften über digitale Produkte einschließlich Bereitstellung, Vertragsmäßigkeit, erforderlicher Aktualisierungen und Rechtsbehelfe unberührt. Ein Verfügbarkeitsziel oder eine Roadmap-Angabe schränkt diese Rechte nicht ein.

Wir haften unbeschränkt bei Vorsatz und grober Fahrlässigkeit, bei Verletzung von Leben, Körper oder Gesundheit, nach dem Produkthaftungsgesetz, bei arglistigem Verschweigen eines Mangels sowie im Umfang einer übernommenen Garantie. Zwingende gesetzliche Haftung, insbesondere nach Art. 82 DSGVO, bleibt unberührt.

Bei einfacher Fahrlässigkeit haften wir für die Verletzung wesentlicher Vertragspflichten, deren Erfüllung die ordnungsgemäße Durchführung erst ermöglicht und auf deren Einhaltung der Kunde regelmäßig vertrauen darf. Die Haftung ist dann auf den bei Vertragsschluss vorhersehbaren, vertragstypischen Schaden begrenzt. Im Übrigen ist die Haftung für einfache Fahrlässigkeit ausgeschlossen, soweit gesetzlich zulässig. Diese Regeln gelten entsprechend für gesetzliche Vertreter und Erfüllungsgehilfen.

Ein Datenverlust wird nicht pauschal dem Kunden zugerechnet: Die vereinbarten Sicherungs- und Wiederherstellungspflichten des Anbieters bleiben maßgeblich. Ein etwaiges Mitverschulden richtet sich nach den gesetzlichen Vorschriften.

## 11. Recht, Gerichtsstand und Streitbeilegung

Es gilt deutsches Recht unter Ausschluss des UN-Kaufrechts. Bei Verbrauchern bleiben zwingende Schutzvorschriften des Staates ihres gewöhnlichen Aufenthalts anwendbar, soweit die gesetzlichen Voraussetzungen vorliegen.

Für Kaufleute, juristische Personen des öffentlichen Rechts und öffentlich-rechtliche Sondervermögen ist Passau Gerichtsstand, soweit gesetzlich zulässig. Für Verbraucher gelten die gesetzlichen Gerichtsstände.

Wir sind weder verpflichtet noch bereit, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen. Die Unwirksamkeit einer einzelnen Klausel berührt den übrigen Vertrag nicht; an ihre Stelle tritt das Gesetz.
...
Wenn Sie diesen Vertrag widerrufen, haben wir Ihnen alle Zahlungen, die wir von Ihnen erhalten haben, einschließlich der Lieferkosten mit Ausnahme zusätzlicher Kosten aufgrund einer von Ihnen gewählten anderen als der von uns angebotenen günstigsten Standardlieferung, unverzüglich und spätestens binnen vierzehn Tagen ab dem Tag zurückzuzahlen, an dem die Mitteilung über Ihren Widerruf bei uns eingegangen ist. Für die Rückzahlung verwenden wir dasselbe Zahlungsmittel, das Sie bei der ursprünglichen Transaktion eingesetzt haben, es sei denn, mit Ihnen wurde ausdrücklich etwas anderes vereinbart. Wegen dieser Rückzahlung berechnen wir keine Entgelte.
...
Wenn Sie den Vertrag widerrufen wollen, füllen Sie dieses Formular aus und senden Sie es zurück. Die nachfolgenden Feldbezeichnungen sind die auszufüllenden Formularfelder.

An: productivity-boost.com Betriebs UG (haftungsbeschränkt) & Co. KG, Reichenbergerstr. 2, 94036 Passau, Deutschland; E-Mail: info@productivity-boost.com
...
- Dienstleistung / Vertrags- oder Kontokennung:
- Bestellt am:
