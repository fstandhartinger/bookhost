...
export const metadata: Metadata = {
  title: "Terms of Service · Wissen",
  description:
    "Terms of service for Wissen, the hosted BookStack service by productivity-boost.com Betriebs UG (haftungsbeschränkt) & Co. KG, Passau, Germany.",
  alternates: { canonical: "https://wissen.app.mintapis.com/terms" },
};
  ...
  return (
    <section className="legal-wrapper">
      <div className="legal-intro" lang="en">
        ...
        <p>
          Wissen provides a hosted BookStack workspace per team for €39 per month plus applicable
